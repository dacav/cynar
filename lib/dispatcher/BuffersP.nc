...
module BuffersP {
    ...
    provides interface Buffers;

}
implementation {

    command error_t Buffers.parse(const uint8_t *buffer, const char *fmt,
    ...
    command error_t Buffers.build(uint8_t *buffer, const char *fmt,
